...
/// ```dart
/// final logger = Logger(
///   output: MultiOutput([ConsoleOutput(), DevtrayLogOutput()]),
/// );
/// ```
///
/// [DevtrayLogOutput] is not defined here (it would drag `logger` into the
...
/// `import 'dart:developer'` for `package:devtray/devtray.dart` and
